...
class Analyzer {
            ...
            subjectsOfChange.forEach(subjectOfChange => {
              ...
              switch (r.object) {
                ...
                case namespaces.ns1 + 'asymmetricPredicate':
                  ...
                  break;
                case namespaces.ns1 + 'irreflexivePredicate':
                  this._processOWL_IRREFL(change);
                  break;
                case namespaces.ns1 + 'typeDependency':
                  this._processTYPEDEP(change);
                  break;
              }
  ...
  static _processOWL_IRREFL(change) {
  ...
  static _processTYPEDEP(change) {
    Analyzer._processOWLDISJC(change);
    //TODO: also have the option to another class
  }
